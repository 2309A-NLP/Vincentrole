...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        st.caption(_("PDF智能问答系统 v3.0（表格解析优化版）",
                     "PDF Q&A System v3.0 (Table-Optimized)"))
        st.caption(_("工单编号: 人工智能NLP-RAG-PDF文档的表格解析及检索优化",
                     "WO#: AI-NLP-RAG-PDF-Table-Optimization"))
